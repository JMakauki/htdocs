...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 21, 2022 at 04:51 AM
...
(2, '13301001', 1, '2022-04-20 23:01:14'),
...
('mu.006', 'YVONNE', 'MWANGOSI', '1970-04-11', 'F', NULL, '0756322113', 'ymwangosi@gmail.com', '123'),
('mu.007', 'ROSE', 'SASABO', '1970-08-08', 'F', NULL, '0755321231', 'rsasabo@gmail.com', '123'),
...
('mu.026', 'jonas', 'wamchongo', '0000-00-00', 'M', NULL, '', NULL, '123');
...
('13301026', 'DOMINICK', 'SALAMBA', 'ICT-M', '1999-04-05', 'M', 'NO', '0652255588', 'dsalamba@gmail.com', '123'),
('13301027', 'RICHARD', 'BISHANGWAYO', 'ICT-M', '1999-04-06', 'M', 'NO', '0762255588', 'rbishangwayo@gmail.com', '123'),
('13301028', 'KENNEDY', 'ANTHONY', 'ICT-M', '1999-04-05', 'M', 'NO', '0782255548', 'kantonny@gmail.com', '123'),
('13301029', 'STEVEN', 'MAUYA', 'ICT-M', '1999-05-03', 'M', 'NO', '0782255554', 'smauya@gmail.com', '123'),
...
('13301055', 'LISSA', 'CHIKWENDE', 'ICT-M', '2000-02-11', 'F', 'NO', '0782445588', 'lchikwende@gmail.com', '123'),
('13301056', 'HAMIDA', 'RASHID', 'BAF', '2000-01-12', 'F', 'NO', '0782254488', 'hrashid@gmail.com', '123'),
('13301057', 'HAMIDA', 'MUSA', 'ICT-M', '1999-01-13', 'F', 'NO', '0782455588', 'hmusa@gmail.com', '123'),
...
('13301089', 'TECKLA', 'INNOCENT', 'ICT-M', '1995-04-15', 'F', 'NO', '0787755588', 'tinn@gmail.com', '123'),
('13301090', 'MARIAM', 'URASA', 'ICT-M', '1995-05-16', 'F', 'NO', '0782254488', 'mura@gmail.com', '123'),
('13301091', 'AMINA', 'JUMA', 'ICT-M', '1994-05-17', 'F', 'NO', '0782255546', 'ajuma@gmail.com', '123'),
('13301092', 'SURAIYA', 'ABDUL', 'ICT-M', '1994-04-18', 'F', 'NO', '0782246588', 'sabd@gmail.com', '123'),
('13301093', 'KABULA', 'JAMES', 'ICT-M', '1994-04-20', 'F', 'NO', '0782256488', 'kajam@gmail.com', '123'),
('13301094', 'VIOLETH', 'AMON', 'ICT-M', '1993-04-21', 'F', 'NO', '0782256488', 'vamon@gmail.com', '123'),
('13301095', 'GLORY', 'ANORLD', 'BBA', '1993-04-22', 'F', 'NO', '0782253688', 'gano@gmail.com', '123'),
('13301096', 'ALICE', 'DENIS', 'ICT-M', '1993-04-23', 'F', 'NO', '0782255368', 'alid@gmail.com', '123'),
('13301097', 'ISABELA', 'OSCAR', 'ICT-M', '1992-05-24', 'F', 'NO', '0782236588', 'isosc@gmail.com', '123'),
('13301098', 'CAROLINE', 'JASON', 'ICT-M', '1992-03-25', 'F', 'NO', '0782365588', 'coja@gmail.com', '123'),
('13301099', 'STELLA', 'PAUL', 'ICT-M', '1991-02-26', 'F', 'NO', '0782255368', 'stepa@gmail.com', '123'),
('13301100', 'SHADYA', 'HASSAN', 'ICT-M', '1991-01-27', 'F', 'NO', '0782236588', 'shass@gmail.com', '123');
...
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `user`  AS  select `student`.`regno` AS `username`,`student`.`password` AS `password`,'Student' AS `status` from `student` union select `staff`.`Staff_ID` AS `staff_id`,`staff`.`password` AS `password`,'Staff' AS `status` from `staff` ;
...
--
ALTER TABLE `hostel`
  MODIFY `Hostel_ID` int(3) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=27;

--
-- AUTO_INCREMENT for table `room`
--
ALTER TABLE `room`
  MODIFY `Room_ID` int(3) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=262;
